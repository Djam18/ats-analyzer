...
class JobPosting(Base):
    ...
    scoring_criteria = relationship(
        "ScoringCriterion", back_populates="job_posting", cascade="all, delete-orphan"
    )
    required_skills = relationship(
        "RequiredSkill", back_populates="job_posting", cascade="all, delete-orphan"
    )
    required_languages = relationship(
        "RequiredLanguage", back_populates="job_posting", cascade="all, delete-orphan"
    )
